...
const HomePage = () => {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        ...
        // Filter to include only approved doctors
  ...
  const getSliderSettings = (items) => {
    ...
    return {
      ...
      slidesToScroll: 1,
      centerMode: items.length <= 3, // Center mode if items are less or equal to 3
      ...
      responsive: [
        {
          ...
          settings: {
            ...
            slidesToScroll: 1,
            centerMode: items.length <= 2, // Center mode if items are less or equal to 2
        ...
        },
        {
          ...
          settings: {
            ...
            slidesToScroll: 1,
            centerMode: items.length <= 1, // Center mode if items are less or equal to 1
