...
const Step3 = ({ formData, handleChange, handleNext, handlePrev }) => { 
  ...
  return (
    ...
    <div className="w-1/2 p-6 space-y-4 text-left">
      <div>
  ...
  <div className="w-full h-full bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden">
    <MapComponent center={mapCenter} />
      ...
      <div className="mt-6 flex justify-between">
        <button
          type="button"
          onClick={handlePrev}
          className="bg-gray-400 text-white px-6  py-2 ml-6 rounded-md hover:bg-gray-500 transition duration-300 mb-7"
        >
          Previous
        </button>
        <button
          ...
          className="bg-docsoGreen text-white px-6 py-2 mr-6 rounded-md hover:bg-middleGreen transition duration-300 mb-7"
        >
