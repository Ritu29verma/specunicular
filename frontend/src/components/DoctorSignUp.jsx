...
const SignUp = ({ formData, handleChange, handleNext }) => {
  ...
  const handleFileChange = (e) => {
    handleChange(e); // Pass the file input change to the parent handler
  };
  ...
  return (
    <div className="w-full min-h-screen bg-lightGreen rounded-lg shadow-md">
      ...
      <h3 className="text-xl font-semibold text-middleGreen text-left p-2 ml-4">
       Sign Up as a Doctor
      </h3>
      ...
      <div className="mt-6 flex justify-end items-end ">
          <button
            ...
            className="bg-docsoGreen text-white px-6 py-2 mr-5 mb-7 rounded-md hover:bg-middleGreen transition duration-300"
          >
            Sign Up As a Doctor
          </button>
        </div>
